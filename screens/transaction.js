...
import { View, Text, StyleSheet, TouchableOpacity, Image, ImageBackground, TextInput, KeyboardAvoidingView, Alert, ToastAndroid } from "react-native";
...
export default class TransactionScreen extends React.Component {
    ...
    handleTransaction = async () => {
        ...
        if (!transaction_Type) {
            ...
            Alert.alert("este livro não existe, verifique o id")
            ...
            if (isEligible) {
                var { bookName, studentName } = this.state
                    ...
                    ToastAndroid.show("Livro Entregue", ToastAndroid.SHORT)
            }
